...
:titletext: Geospatial Data Science
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/WP/GeoDataSci
|Internal reference number of this OGC(R) document:  20-001r2 
...
include::clause_01_Doc_Ovw.adoc[]

include::clause_02_DS_Overview.adoc[]

include::clause_03_Big_Geo_Data.adoc[]

include::clause_04_Data_Sci_Teams.adoc[]

include::clause_05_Data_Mgmt.adoc[]

include::clause_06_Analytics.adoc[]

include::clause_07_AI_ML.adoc[]

include::clause_08_Models.adoc[]

include::clause_09_Applications.adoc[]

include::clause_10_Trends.adoc[]

include::clause_11_Recommendations.adoc[]
